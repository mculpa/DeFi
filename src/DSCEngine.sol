...
contract DSCEngine is ReentrancyGuard {
    ...
    constructor(address[] memory tokenAddresses, address[] memory priceFeedAddresses, address dscAddress) {
        ...
        i_dsc = DecentralizedSC(dscAddress);
    }
    ...
    * @note: This function deposits collateral and mints Dsc in a single transaction.
    */
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // Maybe useless here, since the user is burning Dsc, so their health factor should be fine.
    }

    /* 
    * @param collateral: The erc20 collateral address to liquidate from the user
    * @param user: The user who has broken their health factor. Their health factor should be < MIN_HEALTH_FACTOR
    * @param debtToCover: The amount of Dsc you want to improve users health factor 
    * 
    */
        ...
        nonReentrant
    {
        ...
        uint256 totalCollateralRedeem = tokenAmountFromDeptCovered + bonusCollateral;
     ...
     * If Health Factor < 1, then the user is undercollateralized and can be liquidated.
     */
